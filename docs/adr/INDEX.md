...
| [ADR-0052](ADR-0052-web-console-runtime-control-plane.md) | Web Console Runtime Control Plane | ✅ Accepted |
| [ADR-0053](ADR-0053-overview-guided-recovery-and-status.md) | Overview Guided Recovery and Status | ✅ Accepted |
| [ADR-0054](ADR-0054-console-connection-module-and-shared-query-keys.md) | Console Connection Module and Shared Query Keys | ✅ Accepted |
| [ADR-0055](ADR-0055-responsive-voices-table-and-card-presentation.md) | Responsive Voices Table and Card Presentation | ✅ Accepted |
| [ADR-0056](ADR-0056-playground-installed-picker-and-raw-id-override.md) | Playground Installed Voice Picker and Raw ID Override | ✅ Accepted |
| [ADR-0057](ADR-0057-diagnostics-ready-health-and-developer-schema-preview.md) | Diagnostics-Ready Health and Developer Schema Preview | ✅ Accepted |
| [ADR-0058](ADR-0058-console-test-accessibility-and-visual-qa-gates.md) | Console Test, Accessibility, and Visual QA Gates | ✅ Accepted |
| [ADR-0059](ADR-0059-console-design-token-tailwind-artifact.md) | Console DESIGN.md Tailwind Theme Artifact | ✅ Accepted |
